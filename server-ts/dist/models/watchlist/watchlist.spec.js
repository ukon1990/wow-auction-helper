...
let wl = new watchlist_1.Watchlist(), group, item = new watchlist_1.WatchlistItem();
beforeEach(() => {
    wl = new watchlist_1.Watchlist();
    group = 'Enchants';
    item = new watchlist_1.WatchlistItem();
    item.itemID = 130221;
...
describe('Watchlist', () => {
    it('Can restore from localStorage', () => {
        ...
        wl.save();
        const wl2 = new watchlist_1.Watchlist();
        wl2.restore();
...
//# sourceMappingURL=watchlist.spec.js.map
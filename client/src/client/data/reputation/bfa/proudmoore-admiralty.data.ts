...
export const proudmooreAdmiralty: ReputationVendor = {
  id: 2160,
  name: 'Proudmoore Admiralty',
  vendors: [
    new Vendor('Provisioner Fray', true, false, []),
  ],
  expansion: 7,
  professions: {
    171: [
    ...
    773: [
      new ReputationVendorRecipe(38942, 'Contract: Proudmoore Admiralty', 2, [11000000, 0, 0], 'Friendly'),
    ],
    755: [

...
export const seventhLegion: ReputationVendor = {
  id: 2159,
  name: '7th Legion',
  vendors: [
    new Vendor('Vindicator Jaelaana', true, false, []),
  ],
  expansion: 7,
  professions: {
    171: [
    ...
    773: [
      new ReputationVendorRecipe(40132, 'Contract: 7th Legion', 2, [11000000, 0, 0], 'Friendly'),
    ],
    755: [

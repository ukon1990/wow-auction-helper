...
export const stormsWake: ReputationVendor = {
  id: 2162,
  name: 'Storm\'s Wake',
  vendors: [
    new Vendor('Sister Lilyana', true, false, []),
  ],
  expansion: 7,
  professions: {
    171: [
    ...
    773: [
      new ReputationVendorRecipe(38948, 'Contract: Contract: Storm\'s Wake', 2, [11000000, 0, 0], 'Friendly'),
    ],
    755: [
